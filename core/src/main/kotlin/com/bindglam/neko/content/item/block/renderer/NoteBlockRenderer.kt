...
class NoteBlockRenderer(private val block: Block) : BlockRenderer, Packable {
    ...
    override fun pack(zipper: PackZipper) {
        ...
        blockStateData.variants["instrument=${instrument.name.lowercase()},note=${note},powered=${powered}"] = BlockStateData.Variant(block.blockProperties().model().asString())
    ...
    override fun createBlockState(): BlockState = BlockType.NOTE_BLOCK.createBlockData {
